...
# Params
DATA_DIR = 'jcc_occluder_dataset'
MODEL_PATH = 'jcc_occluder_model.pth'
CLASSES_FILE = 'jcc_occluder_classes.txt'
BATCH_SIZE = 8
EPOCHS = 50  # More epochs due to small dataset
LR = 0.001
...
def main():
    ...
    # Transforms (with augmentation for small dataset)
    ...
    model = OccluderNet(num_classes=len(full_dataset.classes)).to(device)
